  ...
  locals: {
    ...
    questions: [
      ...
      },
      {
        ...
        detail:
          "中央地調所確認，核四廠區下方有長2公里的S斷層，且鄰近海域還發現5條活動斷層，連線可達40公里以上。",
      },
      {
    ...
    reasons: [
      {
        header: "核四沒蓋完！",
        detail:
          "核四一號機未通過原能會安全測試，二號機施工未完成。還須面對零件停產、施工團隊解散、重做環評等問題。<strong>最快10年後才有可能使用</strong>。",
      },
      {
        header: "工安頻出包！",
        detail:
          "核四施工問題不斷，曾發生28小時的大停電事故，及偷工減料、違法變更設計、官員收賄、泡水淹水等<strong>共計512件違規事件</strong>，遭監察院糾正19次、罰鍰2290萬。",
      },
      {
        header: "核安有風險！",
        detail:
          "中央地調所確認，<strong>核四下方有長2公里的S斷層，且鄰近海域還發現5條活動斷層，連線可達40公里以上</strong>。福島核災後，老舊核四的耐震設計已不符國際安全標準。",
      },
      {
        header: "核廢難處理！",
        detail:
          "需存放100萬年以上的核廢料，現暫存於核電廠中，由於台灣社會對核廢料存放地點沒有共識，<strong>目前核廢料無處可去</strong>。",
      },
      {
        header: "核四賠錢貨！",
        detail:
          "核四曾五度追加預算，從1697億追加到2838億，現在續建還要<strong>最少再花800億</strong>。與其繼續賠本投資，不如拿來發展更便宜的綠能、儲能。",
      },
    ],
    knowledges: [
      {
